...
class App extends Component {
  ...
  checkBoard = (board, lastRow, lastColumn, player) => {
    //These functions check if the consecutive pieces horizontally, vertically, or diagnoally
    //are equal to the new piece. The functions should return a value. If any of the new constance are 3
    //or greater, then we have a connection of four consecutive pieces. The only exception is verticalCheck,
    //which does not require combining a check in a different direction, so the logic is inheret to its 
    //function. It should only return "true" or "false"
